...
router.get("/search/", async function(req, res, next) {
  ...
  try {
    const searchTerm = req.query.query; // Capture the search term from the 'name' query parameter

    const customers = await Customer.searchByName(searchTerm); // Search customers by name
